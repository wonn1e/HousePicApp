...
//	                     Toast.makeText(getContext(), "정보변경에 실패하였습니다. error code : " + code , Toast.LENGTH_SHORT).show();
//	                  }
//	               });
		   NetworkManager.getInstance().postEditMyData(getContext(), myData.user_num, "닉네임", null, "집이름", null, "집소개", alert, new NetworkManager.OnResultListener<ResultData>() {
...
//						public void onSuccess(ResultData result) {
//							if(myData.alert == 1){
//								Toast.makeText(getContext(), "알람 On", Toast.LENGTH_SHORT).show();
//								btn.setImageResource(R.drawable.btn_checkbox_on);
//						}else{
//								btn.setImageResource(R.drawable.btn_checkbox_off);
//								Toast.makeText(getContext(), "알람 Off", Toast.LENGTH_SHORT).show();
//							}
//							getNewUserData();
//						}
//
