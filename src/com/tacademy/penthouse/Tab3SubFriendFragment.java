...
public class Tab3SubFriendFragment extends Fragment implements OnItemClickListener, OnHeaderClickListener{
	public static final String TAG_LOGOUT = "noFriend";
	...
	Tab3SubNoFriendFragment noFriendFrag;
	int totalPage = 0;
	int pageCnt;
	...
	private void initData(){
		if(myData != null){
			...
			noFriendFrag = new Tab3SubNoFriendFragment();
			if(noFriendFrag != null){ 
				FragmentTransaction ft = getChildFragmentManager()
						.beginTransaction();
				ft.replace(R.id.tab3Container, noFriendFrag, TAG_LOGOUT);
