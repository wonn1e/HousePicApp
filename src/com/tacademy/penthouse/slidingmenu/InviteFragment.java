...
//									postParams.putString("name", "1인 가구를 위한 인테리어 상품 추천 서비스:하우스픽 HousePic");
...
//		}
	...
	private void sendKakaoTalkLink() {// String textType, String linkType,
		try {
			kakaoTalkLinkMessageBuilder.addText("1인 가구를 위한 인테리어 상품 추천 서비스: 하우스픽");// getString(string.kakaolink_text));
